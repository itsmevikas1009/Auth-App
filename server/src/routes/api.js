...
import { AdminDashboard, ApproveUserAccount } from "../controllers/AdminDashboard.controller.js";
...
apiProtected.get('/admin/dashboard', AdminDashboard);

// Approve User Account Route
